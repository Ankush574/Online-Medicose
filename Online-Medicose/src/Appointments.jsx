...
const Appointments = ({ embedded = false }) => {
  ...
  const pushAppointmentToBackend = async (appointment) => {
    try {
      const datetimeString = `${appointment.date} ${appointment.time}`;
      const iso = new Date(datetimeString).toISOString();
      const headers = {
  ...
  const handleBookAppointment = (e) => {
    ...
    pushAppointmentToBackend(newAppointment);
  };
  ...
  const handleUpdateAppointment = (e) => {
    ...
    pushAppointmentToBackend(updatedAppointment);
  };
